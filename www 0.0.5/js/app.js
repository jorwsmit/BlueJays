...
/*
  function signOut() {
    ...
    window.location.href = "http://localhost/www/";
  }
  */
...
function listTutors(course_id) {
    ...
    //window.location.href = "http://localhost/www/tutors.html";
...
function getMessages() {
    ...
    /*<tr>
            ...
            <td>
            <div class="alert alert-success" role="alert"><a href="http://localhost/www/request.html">Accepted</a></div>
            </td>
      </tr>
              */
    ...
    for (var i = 0; i < returndata.length; i++) {
        ...
        if (returndata[i]["accept"] == true) {
            html += "<div class=\"alert alert-success\" role=\"alert\"><a href=\"http://localhost/www/request.html\"><b>Accepted</b></a></div>";
        } else if (returndata[i]["accept"] == false) {
            html += "<div class=\"alert alert-danger\" role=\"alert\"><a href=\"http://localhost/www/request.html\"><b>Declined</b></a></div>";
        } else {
            html += "<div class=\"alert alert-info\" role=\"alert\"><a href=\"http://localhost/www/request.html\"><b>No Response</b></a></div>";
        }
...
function findTutor(course_id) {
    ...
    /* window.location.href = "http://localhost/www/availabletutors.html";
    ...
    while (returndata[i]["tutor_name"] != null){
        ...
        returndata[i]["tutor_name"] +"</td><td>"+course_id+"</td><td><div class=\"alert alert-success\" role=\"alert\"><a href=\"http://localhost/www/request.html\">View Profile</a></div></td>";
        i++;
    }
    ...
    alert("Tutor Name: " + returndata[0]["tutor_name"]);
                ...
                <td>John Doe</td>
                <td>Introduction to Computers and Their Use</td>
                <td><div class="alert alert-success" role="alert"><a href="http://localhost/www/request.html">Accepted</a></div></td>-->
            </tr>
            });*/
    ...
    /*while (i != 0){
        ...
        returndata[i-1]["tutor_name"] +"</td><td>"+course_id+"</td><td><div class=\"alert alert-success\" role=\"alert\"><a href=\"http://localhost/www/request.html\">View Profile</a></div></td></tr>";
        i--;
    }
    */
...
function adminAccount() {
    ...
    html += "<h4><b>Name: </b>" + returndata[0]["name"] + "</h4>";
    html += "<h4><b>Major: </b>" + returndata[0]["major"] + "</h4>";
    html += "<h4><b>Minor: </b>" + returndata[0]["minor"] + "</h4>";
    html += "<h4><b>DOB: </b>" + returndata[0]["dob"] + "</h4>";
    if (returndata[0]["gender"] == "M"){
        html += "<h4><b>Gender: </b>Male</h4>";
    } else if (returndata[0]["gender"] == "F"){
         html += "<h4><b>Gender: </b>" + returndata[0]["gender"] + "</h4>";
        
    html += "<h4><b>City: </b>" + returndata[0]["name"] + "</h4>";
    html += "<h4><b>State: </b>" + returndata[0]["name"] + "</h4>";
    html += "<h4><b>Phone: </b>" + returndata[0]["name"] + "</h4>";
    */
